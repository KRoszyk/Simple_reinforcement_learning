# RL Pytorch Lightning sample of code
...
def main():
    ...
    model = DQNLightning(env=env_name, replay_size=2000, warm_start_steps=2000, episode_length=500, batch_size=256, eps_last_frame=1000)
